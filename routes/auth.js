...
// Email functions now use EmailService
async function sendVerificationEmail(toEmail, verificationCode) {
  return await EmailService.sendVerificationCode(toEmail, verificationCode);
}

async function sendForgotPasswordEmail(toEmail, verificationCode) {
  return await EmailService.sendPasswordResetCode(toEmail, verificationCode);
}
